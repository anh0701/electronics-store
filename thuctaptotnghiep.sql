...
CREATE TABLE `tbl_baocaodoanhthu` (
  `MaBCDT` int NOT NULL,
  `order_date` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, '2024-06-01', '20000000', '7000000', 90, 10),
...
(13, '2024-03-31', '32000000', '17000000', 16, 10),
...
(11, 'binh@gmail.com', NULL, 13, 1, '31eb4', '2024-06-02 05:21:56', NULL);
...
--
ALTER TABLE `tbl_baocaodoanhthu`
  MODIFY `MaBCDT` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `tbl_donhang`
  MODIFY `MaDonHang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbl_sanpham`
  MODIFY `MaSanPham` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `tbl_thongsokythuatsp`
  MODIFY `MaTSKTSP` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
