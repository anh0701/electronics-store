...
<div class="w3layouts-main">
	...
	@endphp
		<form action="{{ route('/DangNhapAdmin') }}" method="post">
			{{ csrf_field() }}
			<input type="text" class="ggg" name="Email" placeholder="E-MAIL" value="{{ old('Email') }}">
			<input type="password" class="ggg" name="MatKhau" placeholder="PASSWORD" value="{{ old('MatKhau') }}">
