                   ...
                   @if ($errors->any())
                    ...
                    <form role="form" action="{{ Route('/ThemDanhMucTSKT') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="TenDMTSKT" placeholder="Tên danh mục thông số kỹ thuật" onkeyup="ChangeToSlug();" id="slug" >
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slug</label>
                            <input type="text" class="form-control" name="SlugDMTSKT" placeholder="Slug" id="convert_slug">
                        </div>
